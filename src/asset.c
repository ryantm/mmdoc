...
void asset_write_to_dir(char *dir, char *asset_file_name, unsigned char *asset_array, unsigned int asset_array_length)
{
...
{
  asset_write_to_dir(dir, "highlight.pack.js", ___src_asset_highlight_pack_js, ___src_asset_highlight_pack_js_len);
}
...
{
  asset_write_to_dir(dir, "fuse.basic.min.js", ___src_asset_fuse_basic_min_js, ___src_asset_fuse_basic_min_js_len);
}
...
{
  asset_write_to_dir(dir, "mono-blue.css", ___src_asset_mono_blue_css, ___src_asset_mono_blue_css_len);
}
...
{
  asset_write_to_dir(dir, "epub.css", ___src_asset_epub_css, ___src_asset_epub_css_len);
}
...
{
  asset_write_to_dir(dir, "minimal.css", ___src_asset_minimal_css, ___src_asset_minimal_css_len);
}
...
{
  asset_write_to_dir(dir, "search.js", ___src_asset_search_js, ___src_asset_search_js_len);
}
